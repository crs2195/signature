    ...
    public class CSC_API_Client
    {
        ...
        public async Task<string> OAuth2_Token(string code)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var postData = "{ \"grant_type\": \"authorization_code\", \"code\": \"" + code + "\", \"client_id\": \"client_ID\", \"client_secret\": \"client_Secred\", \"redirect_uri\": \"https://localhost:44300/\"}";
                var content = new StringContent(postData, Encoding.UTF8, "application/json");
        ...
        public string Timestamp(string access_token, string hash)
        {
